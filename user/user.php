	...
	<main id="main">
		<div class="container">
			<div class="col-lg-12">
				<div class="row">
					<div class="col-md-12">
						<button class="float-right btn btn-primary btn-sm" type="button" id="new_user">Add New <i
...
<script>
	...
	function manage() {
		$('.edit_bus').click(function () {
			uni_modal('Edit New User', 'user/manage_user.php?id=' + $(this).attr('data-id'))
