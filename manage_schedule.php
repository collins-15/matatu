		...
		<div class="col-md-12">
			...
			<div class="form-group mb-2">
				...
				<input type="text" class="datetimepicker form-control" id="departure_time" name="departure_time"
					value="<?php echo isset($meta['departure_time']) ? date('Y/m/d H:i', strtotime($meta['departure_time'])) : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="eta" class="control-label">Estimated Arrival Time</label>
				<input type="text" class="datetimepicker form-control" id="eta" name="eta"
					value="<?php echo isset($meta['eta']) ? date('Y/m/d H:i', strtotime($meta['eta'])) : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="availability" class="control-label">Availabilty</label>
				<input type="number" maxlength="4" class="form-control text-right" id="availability" name="availability"
					value="<?php echo isset($meta['availability']) ? $meta['availability'] : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="price" class="control-label">Price</label>
				<input type="number" maxlength="20" class="form-control text-right" id="price" name="price"
